...
async function showRecipe() {
    try {
        const response = await fetch('https://forkify-api.jonas.io/api/v2/recipes/664c8f193e7aa067e94e8433');
        const data = await response.json();
        if (!response.ok) console.log(`Error: ${data.message} (${response.status})`);
