...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW9yZGFuMDEiLCJhIjoiY203MWlucWZnMDU3czJrc2ZzdGhnYXpldCJ9.ClPDKL5bMRLnM6bZizjNlw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/yordan01/cm71jw4of01az01sd07qy79xc',
    // style URL
    scrollZoom: false
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (resData.status === 'success') {
            ...
            (0, _alerts.showAlert)('error', resData.message);
          }
          _context.next = 14;
          break;
        case 11:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QuC2TLSZMylGgIpKumNlYgcy2GOCrbCWCiPJmE6yrNRkwQYKxzrvnL5nm19Exigkbu9l2yG2XYOiq6pXOgjscp300Q4HO4iNY');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5117" + '/');
